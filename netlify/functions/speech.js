...
exports.handler = async (event, context) => {
  ...
  try {
   ...
   const POSSIBLE_ENDPOINTS = [
    ...
    `https://${AZURE_REGION}.api.cognitive.microsoft.com/cognitiveservices/v1`,
    `https://${AZURE_REGION}.api.cognitive.microsoft.com/cognitiveservices/tts/v1`,
    `https://${AZURE_REGION}.cognitiveservices.azure.com/sts/v1.0/issuetoken`
];

let AZURE_TTS_ENDPOINT = POSSIBLE_ENDPOINTS[0]; // 默认使用第一个
